...
| Error/log monitoring | Open | Belum ada apa pun selain `console.error` lokal. Minimal: Sentry (free tier cukup) atau structured logging. Tidak blocked oleh domain/VPS, bisa dikerjakan lebih dulu (setup akun Sentry + integrasi kode). |
